...
import { POPULAR_STOCK_SYMBOLS } from "../constans";

const FINNHUB_BASE_URL = process.env.FINNHUB_BASE_URL;
const NEXT_PUBLIC_FINNHUB_API_KEY = process.env.NEXT_PUBLIC_FINNHUB_API_KEY;

/**
 * Fetches JSON data from a given URL with caching options.
 * @param url The URL to fetch.
 * @param revalidateSeconds Optional. If provided, uses cache: 'force-cache' with next.revalidate. Otherwise, uses cache: 'no-store'.
...
/**
 * Fetches news articles, either for specific symbols or general market news.
 * @param symbols Optional. An array of stock symbols to fetch news for.
 * @returns A promise that resolves to an array of formatted news articles.
 * @throws Error if fetching news fails.
 */
